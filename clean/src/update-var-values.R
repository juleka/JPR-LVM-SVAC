...
data$actor_country <- gsub('Government of ', '', data$actor_country)
...
data$actor_country <- update_from_CONSTANTS('actor_country', 'fix_actor_country_names')
#clean conflict_country values
data$conflict_country <- update_from_CONSTANTS('conflict_country', 'fix_conflict_names')
